...
/**
 * @interface Parse.Cloud.Validator
 ...
 */
export interface FunctionRequest<T extends Params = Params> {
 ...
 * @property {Object} context The context of the request, which can be used to pass additional information to the trigger.
 */
export interface TriggerRequest<T = Parse.Object> {
    installationId?: string | undefined;
    master?: boolean | undefined;
 ...
 */
export interface ConnectTriggerRequest<T = Parse.Object> extends TriggerRequest<T> {
    clients: number;
 ...
 */
export interface LiveQueryEventTrigger<T = Parse.Object> extends TriggerRequest<T> {
    sessionToken?: string | undefined;
    event: string;
    clients: number;
    subscriptions: number;
 ...
 */
export interface JobRequest<T extends Params = Params> {
    params: T;
    message: (response: string) => void;
}
/**
 ...
 */
export interface BeforeFindRequest<T extends Parse.Object = Parse.Object> extends TriggerRequest<T> {
    query: Parse.Query<T>;
    count: boolean;
    isGet: boolean;
 ...
 * @property {Object} log The current logger inside Parse Server.
 */
export interface AfterFindRequest<T = Parse.Object> extends TriggerRequest<T> {
    objects: T[];
}
export interface AfterSaveRequest<T = Parse.Object> extends TriggerRequest<T> {
}
export interface AfterDeleteRequest<T = Parse.Object> extends TriggerRequest<T> {
}
export interface BeforeDeleteRequest<T = Parse.Object> extends TriggerRequest<T> {
}
export interface BeforeSaveRequest<T = Parse.Object> extends TriggerRequest<T> {
}
/** @namespace
 * @name Parse
 ...
 * @param {(Object|Function)} validator An optional function to help validating cloud code. This function can be an async function and should take one parameter a {@link Parse.Cloud.FunctionRequest}, or a {@link Parse.Cloud.Validator}.
 */
export declare function define(functionName: string, handler: (request: FunctionRequest) => any, validationHandler?: Validator | ((request: FunctionRequest) => any)): void;
export declare function define<T extends () => any>(functionName: string, handler: (request: FunctionRequest<{}>) => Promise<ReturnType<T>> | ReturnType<T>, validationHandler?: Validator | ((request: FunctionRequest) => any)): void;
/**
 ...
 * @param {String} functionName The name of the Background Job
 * @param {Function} handler The Background Job to register. This function can be async should take a single parameters a {@link Parse.Cloud.JobRequest}
 *
 */
export declare function job(functionName: string, handler?: (request: JobRequest) => Promise<void> | void): void;
/**
 *
 ...
 * @param {(Object|Function)} validator An optional function to help validating cloud code. This function can be an async function and should take one parameter a {@link Parse.Cloud.TriggerRequest}, or a {@link Parse.Cloud.Validator}.
 */
export declare function beforeSave<T extends Parse.Object = Parse.Object>(parseClass: {
    new (): T;
} | string, handler?: (request: BeforeSaveRequest<T>) => Promise<void> | void, validationHandler?: Validator | ((request: FunctionRequest) => any)): void;
/**
 ...
 * @param {(Object|Function)} validator An optional function to help validating cloud code. This function can be an async function and should take one parameter a {@link Parse.Cloud.TriggerRequest}, or a {@link Parse.Cloud.Validator}.
 */
export declare function beforeDelete<T extends Parse.Object = Parse.Object>(parseClass: {
    new (): T;
} | string, handler?: (request: BeforeDeleteRequest<T>) => Promise<void> | void, validationHandler?: Validator | ((request: FunctionRequest) => any)): void;
/**
 *
 ...
 */
export declare function beforeLogin(handler?: (request: TriggerRequest<Parse.User>) => PromiseLike<void> | void, validationHandler?: Validator | ((request: FunctionRequest) => any)): void;
/**
 *
 ...
 */
export declare function afterLogin(handler?: (request: TriggerRequest<Parse.User>) => PromiseLike<void> | void): void;
/**
 *
 ...
 */
export declare function afterLogout(handler?: (request: TriggerRequest<Parse.Session>) => PromiseLike<void> | void): void;
/**
 ...
 * @param {(Object|Function)} validator An optional function to help validating cloud code. This function can be an async function and should take one parameter a {@link Parse.Cloud.TriggerRequest}, or a {@link Parse.Cloud.Validator}.
 */
export declare function afterSave<T extends Parse.Object = Parse.Object>(parseClass: {
    new (): T;
} | string, handler?: (request: AfterSaveRequest<T>) => Promise<void> | void, validationHandler?: Validator | ((request: FunctionRequest) => any)): void;
/**
 ...
 * @param {(Object|Function)} validator An optional function to help validating cloud code. This function can be an async function and should take one parameter a {@link Parse.Cloud.TriggerRequest}, or a {@link Parse.Cloud.Validator}.
 */
export declare function afterDelete<T extends Parse.Object = Parse.Object>(parseClass: {
    new (): T;
} | string, handler?: (request: AfterDeleteRequest<T>) => Promise<void> | void, validationHandler?: Validator | ((request: FunctionRequest) => any)): void;
/**
 ...
 * @param {(Object|Function)} validator An optional function to help validating cloud code. This function can be an async function and should take one parameter a {@link Parse.Cloud.BeforeFindRequest}, or a {@link Parse.Cloud.Validator}.
 */
export declare function beforeFind<T extends Parse.Object = Parse.Object>(parseClass: {
    new (): T;
} | string, handler?: (request: BeforeFindRequest<T>) => Promise<Parse.Query<T>> | Promise<void> | Parse.Query<T> | void, validationHandler?: Validator | ((request: FunctionRequest) => any)): void;
/**
 ...
 * @param {(Object|Function)} validator An optional function to help validating cloud code. This function can be an async function and should take one parameter a {@link Parse.Cloud.AfterFindRequest}, or a {@link Parse.Cloud.Validator}.
 */
export declare function afterFind<T extends Parse.Object = Parse.Object>(parseClass: {
    new (): T;
} | string, handler?: (request: AfterFindRequest<T>) => any, validationHandler?: Validator | ((request: FunctionRequest) => any)): void;
/**
 ...
 * @param {(Object|Function)} validator An optional function to help validating cloud code. This function can be an async function and should take one parameter a {@link Parse.Cloud.ConnectTriggerRequest}, or a {@link Parse.Cloud.Validator}.
 */
export declare function beforeConnect<T extends Parse.Object = Parse.Object>(handler?: (request: ConnectTriggerRequest<T>) => any, validationHandler?: Validator | ((request: FunctionRequest) => any)): void;
/**
 ...
 */
export declare function sendEmail(data: any): any;
/**
 ...
 * @param {(Object|Function)} validator An optional function to help validating cloud code. This function can be an async function and should take one parameter a {@link Parse.Cloud.TriggerRequest}, or a {@link Parse.Cloud.Validator}.
 */
export declare function beforeSubscribe<T extends Parse.Object = Parse.Object>(parseClass: {
    new (): T;
} | string, handler?: any, validationHandler?: Validator | ((request: FunctionRequest) => any)): void;
export declare function onLiveQueryEvent(handler: any): void;
/**
 ...
 * @param {(Object|Function)} validator An optional function to help validating cloud code. This function can be an async function and should take one parameter a {@link Parse.Cloud.LiveQueryEventTrigger}, or a {@link Parse.Cloud.Validator}.
 */
export declare function afterLiveQueryEvent<T extends Parse.Object = Parse.Object>(parseClass: {
    new (): T;
} | string, handler?: (request: LiveQueryEventTrigger<T>) => Promise<void> | void, validationHandler?: Validator | ((request: FunctionRequest) => any)): void;
export declare function _removeAllHooks(): void;
export declare function useMasterKey(): void;
export {};
